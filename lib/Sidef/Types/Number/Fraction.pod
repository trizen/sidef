...
Sidef::Types::Number::Fraction - Symbolic implementation for fractions.

=head1 DESCRIPTION

This class implements symbolic support for rational values (fractions) in Sidef. It inherits from L<Sidef::Types::Number::Number>.
