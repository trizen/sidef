...
Returns an array with all the Carmichael numbers <= n or in the range C<a..b> that have exactly C<k> prime factors.
...
Iterates over the Carmichael <= n or in the range C<a..b> that have exactly C<k> prime factors.
...
Returns an array with all the Carmichael numbers <= n or in the range C<a..b> that are also strong Fermat pseudoprimes to C<base> and have exactly C<k> prime factors.
...
Iterates over the Carmichael <= n or in the range C<a..b> that are also strong Fermat pseudoprimes to C<base> and have exactly C<k> prime factors.
...
Iterates over the C<k>-omega Fermat pseudoprimes <= n or in the range C<a..b>.
...
Iterates over the Lucas-Carmichael <= n or in the range C<a..b> that have exactly C<k> prime factors.
...
Iterates over the C<k>-omega primes <= n, or in the range C<a..b>.
...
Iterate over prime powers <= n, or in the range C<a..b>:
...
Iterates over the squarefree Fermat pseudoprimes <= n or in the range C<a..b> that have exactly C<k> prime factors.
...
Iterate over the squarefree semiprimes <= n, or in the range C<a..b>:
...
Iterates over the squarefree strong Fermat pseudoprimes <= n or in the range C<a..b> that have exactly C<k> prime factors.
...
Iterates over the C<k>-omega strong Fermat pseudoprimes <= n or in the range C<a..b>.
...
Returns an array with all the C<k>-omega Fermat pseudoprimes to the given C<base> that are <= n or in the range C<a..b>.
...
Equivalently, C<k>-omega primes are numbers n such that C<omega(n) == k>.
...
Returns an array with all the Lucas-Carmichael numbers <= n or in the range C<a..b> that have exactly C<k> prime factors.
...
Returns the C<k>-omega prime divisors of n.
...
Returns the number of C<k>-omega primes <= n, or in the range C<a..b>.
...
Returns an array with C<k>-omega primes <= n, or in the range C<a..b>.
...
Returns an array with the prime powers <= n, or in the range C<a..b>.
...
Returns the sum of the unitary prime power divisors of n, each divisor raised to power C<k>.
...
Sum of the prime numbers <= n, or in the range C<a..b>, each prime raised to the k-th power.
...
Returns an array with all the squarefree Fermat pseudoprimes to the given C<base> that are <= n or in the range C<a..b> and have exactly C<k> prime factors.
...
Counts the number of squarefree semiprimes <= n (OEIS: A072613), or in the range C<a..b>.
...
Returns an array with the squarefree semiprimes <= n, or in the range C<a..b>.
...
Returns an array with all the squarefree strong Fermat pseudoprimes to the given C<base> that are <= n or in the range C<a..b> and have exactly C<k> prime factors.
...
Returns an array with all the strong Fermat pseudoprimes to the given C<base> that are <= n or in the range C<a..b> and have C<k> distinct prime factors.
...
Returns an array of C<[a,b]> pairs, with a <= b, containing all the positive solutions to the equation:
