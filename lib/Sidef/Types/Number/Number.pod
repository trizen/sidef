...
=head1 SYNOPSIS
    ...
    say 5040.factor                # Prime factorization
...
Returns the C<TAU> constant (C<2*PI>), or the number of positive divisors of C<n>.
...
Returns all the solutions C<x> to the Euler totient function: C<phi(x) = n>.
...
Returns the largest solution x to the Euler totient function: C<phi(x) = n>.
...
Returns the smallest solution x to the Euler totient function: C<phi(x) = n>.
...
Returns all the solutions C<x> to Dedekind's psi function: C<psi(x) = n>.
...
Returns the largest solution x to the sum of divisors function: C<sigma_k(x) = n>.
...
Returns the smallest solution x to the sum of divisors function: C<sigma_k(x) = n>.
...
Returns an array with all the possible solutions C<x> to C<usigma(x) = n>.
