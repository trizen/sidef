...
Returns an array with all the Carmichael numbers <= n or in the range C<a..b> that have exactly C<k> prime factors.
    ...
    say 3.carmichael(10000)              # 3-Carmichael numbers
    say 4.carmichael(10000, 100000)      # 4-Carmichael numbers in range
...
Iterates over the Carmichael <= n or in the range C<a..b> that have exactly C<k> prime factors.
    ...
    4.carmichael_each(1e5, 1e6, {|n| say n })     # iterate over 4-Carmichael in range 1e4..1e6
...
Returns an array with all the squarefree strong Fermat pseudoprimes to the given C<base> that are <= n or in the range C<a..b> and have exactly C<k> prime factors.
    ...
    say 3.squarefree_strong_fermat_psp(2, 1000000)               # squarefree strong 3-Fermat psp to base 2
    say 4.squarefree_strong_fermat_psp(2, 10000000, 100000000)   # squarefree strong 4-Fermat psp to base 2 in range
