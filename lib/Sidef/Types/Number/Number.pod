...
When an additional argument is given, it returns the number of primes in the range n..m:
...
k.almost_primes(n) -> I<Obj>
k.almost_primes(a,b) -> I<Obj>
...
composite_count(n) -> I<Obj>
composite_count(a,b) -> I<Obj>
...
Number.digits2num(digits...) -> I<Obj>
...
Number.dirichlet_sum(f, g, F, G) -> I<Obj>
...
k.each_almost_prime(n, {...}) -> I<Obj>
k.each_almost_prime(a,b, {...}) -> I<Obj>
...
Number.each_squarefree(upto, {...}) -> I<Obj>
...
k.each_squarefree_almost_prime(n, {...}) -> I<Obj>
k.each_squarefree_almost_prime(a,b,{...}) -> I<Obj>
...
Number.ecm_factor(B) -> I<Obj>
Number.ecm_factor(B,reps) -> I<Obj>
...
Number.faulhaber_polynomial(x) -> I<Obj>
...
Number.fermat_factor(k=1e4) -> I<Obj>
...
Number.flt_factor(base=2, tries=1e4) -> I<Array>
...
Number.inverse_polygonal() -> I<Array>
...
Number.inverse_psi_len() -> I<Number>
...
Number.inverse_psi_max() -> I<Number>
...
Number.inverse_psi_min() -> I<Number>
...
Number.inverse_sigma(k=1) -> I<Obj>
...
Number.inverse_sigma_len(k=1) -> I<Obj>
...
Number.inverse_sigma_max() -> I<Obj>
...
Number.inverse_sigma_min() -> I<Obj>
...
Number.is_almost_prime(k) -> I<Obj>
...
Number.is_between(min, max) -> I<Obj>
...
Return true if `n` passes the B-PSW primality test (extra-strong variant).
...
Number.is_euler_psp(bases...) -> I<Obj>
...
Number.is_fib_psp(P=1, Q=-1) -> I<Obj>
...
Number.is_frobenius_psp(a,b) -> I<Obj>
...
Number.is_gaussian_prime(b) -> I<Obj>
...
Number.is_lucasv_psp(P=1, Q=-1) -> I<Obj>
...
Number.is_prob_squarefree(k) -> I<Obj>
...
Number.is_strong_psp(bases...) -> I<Obj>
...
Number.is_super_psp(bases...) -> I<Obj>
...
Number.lucas_factor(j=1, tries=100) -> I<Obj>
...
Number.miller_factor(tries=100) -> I<Obj>
...
Number.miller_rabin_random(k) -> I<Obj>
...
Number.n_composites(start=4) -> I<Obj>
...
Number.next_palindrome(b=10) -> I<Obj>
...
Number.pbrent_factor(reps) -> I<Obj>
...
k.powerful_count(n) -> I<Obj>
k.powerful_count(a,b) -> I<Obj>
...
prime_power_count(n) -> I<Obj>
prime_power_count(a,b) -> I<Obj>
...
Counts the number of semiprimes <= n. (see: A072000)
...
Example:
    ...
    say 30.of { smooth_count(10**_, 13) }   #=> A106629

=cut

=head2 smooth_part

Number.smooth_part(k) -> I<Obj>
...
k.squarefree_almost_primes(n) -> I<Obj>
k.squarefree_almost_primes(a,b) -> I<Obj>
...
Number.squfof_factor(reps) -> I<Obj>
...
Number.trial_factor(limit) -> I<Obj>
