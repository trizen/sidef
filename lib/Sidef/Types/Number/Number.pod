...
Returns an array with the cubeful numbers <= C<n>, or in the range C<a..b>.
...
Returns the count of cubeful numbers <= C<n>, or in the range C<a..b>.
...
Iterates over the cubeful numbers <= C<n>, or in the range C<a..b>.

Aliases: I<each_cubeful>
...
Returns the sum of cubeful numbers <= C<n>, or in the range C<a..b>.
...
=head2 each_squareful

    n.squareful_each { ... }
    squareful_each(a, b, { ... })

Iterates over the squareful numbers <= C<n>, or in the range C<a..b>.

Aliases: I<squareful_each>
...
Returns true if C<n> is an absolute Euler pseudoprime: p-1 | (n-1)/2 for every p|n, where C<n> is a squarefree composite integer.
...
Returns an array with the squareful numbers <= C<n>, or in the range C<a..b>.

=cut

=head2 squareful_count

    squareful_count(n)
    squareful_count(a,b)

Returns the count of squareful numbers <= C<n>, or in the range C<a..b>.
...
Returns the sum of squareful numbers <= C<n>, or in the range C<a..b>.
