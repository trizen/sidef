...
Compute C<k> terms of the continued-fraction expansion of C<n>.

Example:

    say sqrt(12).as_cfrac(6)    # [3, 2, 6, 2, 6, 2]

Can also be used to compute very good rational approximations to a given real number:

    say Num.pi.as_cfrac(10).flip.reduce{|a,b| b + 1/a }.as_rat      # 1146408/364913
...
Number.bernoulli_polynomial() -> I<Obj>
...
N-th Catalan number. When an additional argument is provided, it returns the C<C(n,k)> entry in Catalan's triangle.
...
Number.is_euler_pseudoprime() -> I<Obj>
...
Number.is_frobenius_pseudoprime() -> I<Obj>
...
=head2 is_khashin_pseudoprime

Number.is_khashin_pseudoprime() -> I<Obj>

Return the

Aliases: I<is_frobenius_khashin_pseudoprime>

=cut

=head2 is_lucas_pseudoprime

Number.is_lucas_pseudoprime() -> I<Obj>
...
=head2 is_plumb_pseudoprime

Number.is_plumb_pseudoprime() -> I<Obj>

Return the

Aliases: I<is_euler_plumb_pseudoprime>
...
=head2 is_stronger_lucas_pseudoprime

Number.is_stronger_lucas_pseudoprime() -> I<Obj>

Return the

Aliases: I<is_extra_strong_lucas_pseudoprime>
...
Number.is_strong_lucas_pseudoprime() -> I<Obj>
...
Number.is_strong_pseudoprime() -> I<Obj>
...
=head2 is_underwood_pseudoprime

Number.is_underwood_pseudoprime() -> I<Obj>

Return the

Aliases: I<is_frobenius_underwood_pseudoprime>
...
Aliases: I<number_of_partitions>
...
=head2 squarefree_sigma0

Number.squarefree_sigma0() -> I<Obj>
...
Aliases: I<mobius>, I<möbius>, I<moebius>
...
Aliases: I<big_omega>, I<bigomega>, I<prime_power_sigma0>
...
Aliases: I<totient>, I<euler_phi>, I<eulerphi>, I<euler_totient>
