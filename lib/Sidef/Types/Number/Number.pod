...
=head2 each_squarefree_fermat

    k.squarefree_fermat_each(base, n, { ... })
    k.squarefree_fermat_each(base, a, b, { ... })

Iterates over the Fermat pseudoprimes <= n or in the range C<a..b> that have exactly C<k> prime factors.

    3.squarefree_fermat_each(2, 1e5, {|n| say n })          # iterate over 3-Fermat psp to base 2 <= 1e5
    4.squarefree_fermat_each(2, 1e5, 1e6, {|n| say n })     # iterate over 4-Fermat psp to base 2 in range 1e4..1e6

Aliases: I<squarefree_fermat_each>
...
=head2 squarefree_fermat

    k.squarefree_fermat(base, n)
    k.squarefree_fermat(base, a, b)
...
Returns an array with all the Fermat pseudoprimes to the given C<base> <= n or in the range C<a..b> that have exactly C<k> prime factors.
    ...
    say 3.squarefree_fermat(2, 10000)         # 3-Fermat psp to base 2
    say 4.squarefree_fermat(2, 10000, 100000) # 4-Fermat psp to base 2 in range
