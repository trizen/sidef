...
When C<k> is omitted, an array of arrays with the k-almost prime divisors of C<n>, for each k in the range C<0..bigomega(n)>, is returned:
...
Returns the number of composite numbers <= C<n>, or in the range C<a..b>.
...
Returns the number of positive divisors of C<n>.
...
Iterates over the C<k>-omega Fermat pseudoprimes <= C<n> or in the range C<a..b>.
...
Iterates over the numbers <= C<n>, or in the range C<a..b>, that are not C<k>-powerfree.
...
Iterates over the C<k>-omega primes <= C<n>, or in the range C<a..b>.

C<k>-omega primes are numbers C<n> that satisfy C<omega(n) == k>.
...
Iterates over the C<k>-omega strong Fermat pseudoprimes <= C<n> or in the range C<a..b>.
...
Returns an array with all the C<k>-omega Fermat pseudoprimes to the given C<base> that are <= C<n> or in the range C<a..b>.
...
Returns true if C<n> is not divisible by any perfect cube.
...
Return true if C<n> is a C<k>-omega prime (i.e.: true if C<n> is divisible by exactly C<k> different primes).

Equivalently, C<k>-omega primes are numbers C<n> such that C<omega(n) == k>.
...
Returns the C<n>-th Lucas number.
...
Returns the next C<k>-omega prime greater than C<n>.
...
Returns the number of numbers <= C<n>, or in the range C<a..b>, that are not k-powerfree.
...
Returns the C<n>-th C<k>-omega prime.
...
Returns the C<k>-omega prime divisors of C<n>.

    say 5040.omega_prime_divisors(4)    #=> [210, 420, 630, 840, 1260, 1680, 2520, 5040]

When C<k> is omitted, an array of arrays with the C<k>-omega prime divisors of C<n>, for each C<k> in the range C<0..omega(n)>, is returned:
...
Returns the number of C<k>-omega primes <= C<n>, or in the range C<a..b>.
...
Returns an array with C<k>-omega primes <= C<n>, or in the range C<a..b>.
...
Returns the number of k-almost primes <= C<n>, or in the range C<a..b>.
...
Returns the number of perfect powers <= C<n>.
...
Returns the number of primes <= C<n>, or in the range C<a..b>.
...
Returns the number of prime powers <= C<n>, or in the range C<a..b>.
...
Returns the number of prime power divisors of C<n>.
...
Returns the number of unitary prime power divisors of C<n>.
...
Returns the number of prime divisors of C<n>.
...
Returns the number of k-rough numbers <= C<n>, or in the range C<a..b>.
...
Returns the number of k-smooth numbers <= C<n>, or in the range C<a..b>.
...
Returns the number of squarefree integers <= C<n>, or in the range C<a..b>.
...
Returns the number of squarefree k-almost primes <= C<n>, or in the range C<a..b>.
...
Returns the number of unitary divisor of C<n>.

Equivalently, the number of squarefree divisors of C<n>.
