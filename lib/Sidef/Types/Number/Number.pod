...
Returns true if C<n> is probably prime. The method does some trial division, then it performs a B-PSW test.
...
Returns the previous prime smaller than C<n>.
...
Returns the count of primes <= C<n>, or in the range C<a..b>.
...
Returns an array with the prime numbers <= C<n>, or in the range C<a..b>.
...
Returns a random prime <= C<n>, or in the range C<a..b>.
