...
Iterates over the Fermat pseudoprimes <= n or in the range C<a..b> that have exactly C<k> prime factors.
...
Returns an array with all the Fermat pseudoprimes to the given C<base> that are <= n or in the range C<a..b> and have C<k> distinct prime factors.
