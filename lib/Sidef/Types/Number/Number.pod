...
Aliases: I<lucas_carmichael_each>
...
=head2 each_squarefree_fermat_psp
...
Aliases: I<squarefree_fermat_psp_each>
...
Aliases: I<squarefree_semiprimes_each>

=cut

=head2 each_squarefree_strong_fermat_psp
...
Aliases: I<squarefree_strong_fermat_psp_each>
...
Aliases: I<squarefull_each>

=cut

=head2 each_strong_fermat_psp
...
Aliases: I<strong_fermat_psp_each>
...
=head2 prime_signature_numbers

    prime_signature_numbers(lo, hi, prime_signature)

Returns an array of numbers in range C<[lo, hi]> that have a given prime signature.

    say prime_signature_numbers(1, 1e3, [1])        #=> prime numbers
    say prime_signature_numbers(1, 1e3, [2])        #=> squares of numbers
    say prime_signature_numbers(1, 1e3, [2,1])      #=> squares of primes times another prime
    say prime_signature_numbers(1, 1e3, [2,1,1])    #=> numbers of the form p^2*q*r

=cut

=head2 prime_signature_count

    prime_signature_count(lo, hi, prime_signature)

Count numbers in range C<[lo, hi]> that have a given prime signature.

    say 10.of {|n| prime_signature_count(1, 10**n, [1]) }      # prime number count
    say 10.of {|n| prime_signature_count(1, 10**n, [1,1]) }    # A036351
    say 10.of {|n| prime_signature_count(1, 10**n, [1,1,1]) }  # A215218
