...
=head2 each_non_cubefree

    n.non_cubefree_each { ... }
    non_cubefree_each(a, b, { ... })

Iterates over the non-cubefree numbers <= C<n>, or in the range C<a..b>.

Aliases: I<non_cubefree_each>

=cut

=head2 each_non_powerfree

    k.non_powerfree_each(n, { ... })
    k.non_powerfree_each(a, b, { ... })

Iterates over the numbers <= C<n>, or in the range C<a..b>, that are not k-powerfree.

    2.non_powerfree_each(100, {|n| say n })         # iterate over non-squarefree numbers <= 100
    3.non_powerfree_each(50, 100, {|n| say n })     # iterate over non-cubefree numbers in range 50..100

Aliases: I<non_powerfree_each>

=cut

=head2 each_non_squarefree

    n.non_squarefree_each { ... }
    non_squarefree_each(a, b, { ... })

Iterates over the non-squarefree numbers <= C<n>, or in the range C<a..b>.

Aliases: I<non_squarefree_each>
...
Given a positive integer and an array of integers, it tries to find non-trivial factors of C<n>, checking each C<gcd(n, array[0])>, C<gcd(n, array[1])>, etc.
...
Returns all the solutions C<x> to the Dedekin psi function: C<psi(x) = n>.
...
Returns the largest solution x to the Dedekind psi function: C<psi(x) = n>.
...
Returns the smallest solution x to the Dedekind psi function: C<psi(x) = n>.
...
Returns true if C<g> is a non-trivial integer factor of C<n>.
...
Returns true iff C<n> is not a power and is not divisible by a square <= C<k>.
...
Returns the index of the least significant bit of C<n> that is non-zero.
...
Returns the sum of the non-exponential divisors of C<n>, each divisor raised to the k-th power.
...
Returns the count of the non-exponential divisors of C<n>.
...
Given a non-negative integer C<n>, returns the next composite number greater than C<n>.
...
=head2 next_non_cubefree

    n.next_non_cubefree

Returns the next non-cubefree number greater than C<n>.

=cut

=head2 next_non_powerfree

    n.next_non_powerfree(k=2)

Returns the next non-k-powerfree number greater than C<n>.

=cut

=head2 next_non_squarefree

    n.next_non_squarefree

Returns the next non-squarefree number greater than C<n>.
...
Given a non-negative integer C<n>, returns the next prime power (C<p^k> with k >= 1) greater than C<n>.
...
Returns the sum of the non-infinitary divisors of C<n>, each divisor raised to the k-th power.
...
Returns the count of the non-infinitary divisors of C<n>.
...
Returns an array with the non-cubefree numbers <= C<n>, or in the range C<a..b>.

=cut

=head2 non_cubefree_count

    non_cubefree_count(n)
    non_cubefree_count(a,b)

Returns the count of non-cubefree numbers <= C<n>, or in the range C<a..b>.

=cut

=head2 non_cubefree_sum

    non_cubefree_sum(n)
    non_cubefree_sum(a,b)

Returns the sum of non-cubefree numbers <= C<n>, or in the range C<a..b>.
...
Returns an array of numbers <= C<n>, or in the range C<a..b>, that are not k-powerfree.
    ...
    say 2.non_powerfree(100)        # numbers that are not squarefree <= 100
    say 3.non_powerfree(50, 100)    # numbers that are not cubefree in range 50..100

=cut

=head2 non_powerfree_count

    k.non_powerfree_count(n)
...
=head2 non_powerfree_sum

    k.non_powerfree_sum(n)
    k.non_powerfree_sum(a,b)

Returns the sum of numbers <= C<n>, or in the range C<a..b>, that are not k-powerfree.

=cut

=head2 non_squarefree

    non_squarefree(n)
    non_squarefree(a,b)

Returns an array with the non-squarefree numbers <= C<n>, or in the range C<a..b>.

=cut

=head2 non_squarefree_count

    non_squarefree_count(n)
    non_squarefree_count(a,b)

Returns the count of non-squarefree numbers <= C<n>, or in the range C<a..b>.

=cut

=head2 non_squarefree_sum

    non_squarefree_sum(n)
    non_squarefree_sum(a,b)

Returns the sum of non-squarefree numbers <= C<n>, or in the range C<a..b>.
...
=head2 nth_non_cubefree

    n.nth_non_cubefree

Returns the n-th non-cubefree number.

=cut

=head2 nth_non_powerfree

    n.nth_non_powerfree(k)

Returns the n-th k-non-powerfree number.

    say nth_non_powerfree(1e9, 2)   #=> 2550546152
    say nth_non_powerfree(1e9, 3)   #=> 5949100928
    say nth_non_powerfree(1e9, 4)   #=> 13147239114

=cut

=head2 nth_non_squarefree

    n.nth_non_squarefree

Returns the n-th non-squarefree number.
...
Returns the sum of the non-unitary divisors of C<n>, each divisor raised to the k-th power.
...
Returns the count of the non-unitary divisors of C<n>.
...
=head2 prev_non_cubefree

    n.prev_non_cubefree

Returns the previous non-cubefree number smaller than C<n>.

=cut

=head2 prev_non_powerfree

    n.prev_non_powerfree(k)

Returns the previous non-k-powerfree number smaller than C<n>.

=cut

=head2 prev_non_squarefree

    n.prev_non_squarefree

Returns the previous non-squarefree number smaller than C<n>.
...
Returns the least quadratic non-residue of C<n>.
...
Given a positive integer C<n>, returns a random unsigned integer smaller than C<n>.

    say urand(100)          # random integer in [0,99]

When two arguments are given, returns a uniform random unsigned integer in the range C<[a,b]> (inclusive on both ends).

    say urand(100, 110)     # random integer in [100, 110]

Both arguments must be non-negative. If C<a> is greater than C<b>, then function will return a random integer in the range C<[b,a]>.
...
Takes a non-negative integer C<n>, which is used to seed the internal CSPRNG used for random functions, such as C<urand> and the random prime functions.
