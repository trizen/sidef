...
It efficiently generates all the k-powerful numbers <= C<n>, or in the range C<a..b>.
...
It efficiently counts the number of k-powerful numbers <= C<n>, or in the range C<a..b>;
