...
Returns the sum of the bi-unitary divisors of C<n>, each divisor raised to the k-th power.
...
Returns the count of the bi-unitary divisors of C<n>.
...
Returns the sum of the exponential divisors (or e-divisors) of C<n>, each divisor raised to k-th power.
...
Returns the count of the exponential divisors (or e-divisors) of C<n>.
...
Returns the sum of largest prime factors of numbers from C<1> to C<n>, or in the range C<a..b>.
...
Returns true if C<n> is an absolute Euler pseudoprime: C<p-1 | (n-1)/2> for every C<p|n>, where C<n> is a squarefree composite integer.
...
Returns true if C<n> is an abundant number, else false.
...
Returns the sum of the infinitary divisors of C<n>, each divisor raised to the k-th power.
...
Returns the count of the infinitary divisors of C<n>.
...
Returns true if C<n> is a practical number (OEIS: A005153).
...
Returns true if C<n> is a primitive abundant number, else false.
...
Returns the sum of least prime factors of numbers from C<1> to C<n>, or in the range C<a..b>.
...
Returns the sum of the non-bi-unitary divisors of C<n>, each divisor raised to the k-th power.
...
Returns the sum of the nonexponential divisors of C<n>, each divisor raised to the k-th power.
...
Returns the count of the nonexponential divisors of C<n>.
...
Returns the sum of the noninfinitary divisors of C<n>, each divisor raised to the k-th power.
...
Returns the count of the noninfinitary divisors of C<n>.
...
Returns the sum of the nonunitary divisors of C<n>, each divisor raised to the k-th power.
...
Returns the count of the nonunitary divisors of C<n>.
...
Pillai's arithmetical function: C<Sum_{k=1..n} gcd(k, n)>. (OEIS: A018804)
...
Counts the number of semiprimes <= C<n> (OEIS: A072000), or in the range C<a..b>.
...
Sum of the distinct primes dividing C<n>.
...
Sum of the primes dividing C<n> (with repetition).
...
Returns the length of the period of continued fraction for square root of C<n>. (OEIS: A003285)
...
Counts the number of squarefree semiprimes <= C<n> (OEIS: A072613), or in the range C<a..b>.
...
Returns the sum of squarefree numbers <= C<n> or in the range C<a..b>. (OEIS: A066779)
...
Returns the product of first C<n> factorials.
...
Returns the product of first C<n> primorials.
