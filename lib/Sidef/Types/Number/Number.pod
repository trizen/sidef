...
Iterates over the squarefull numbers <= C<n>, or in the range C<a..b>.
...
Returns the next k-powerful number greater than C<n>.
...
Returns the n-th k-powerful number.
...
Efficiently generates all the k-powerful numbers <= C<n>, or in the range C<a..b>.
...
Efficiently counts the number of k-powerful numbers <= C<n>, or in the range C<a..b>.
...
Efficiently sums the k-powerful numbers <= C<n>, or in the range C<a..b>.
...
Returns the previous k-powerful number smaller than C<n>.
