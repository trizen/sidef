package Sidef::Types::Number::QuadraticElement {
    ...
    # Constructor: QuadraticElement(a, b, p, q) where t^2 = p + q*t
    sub new {
        my ($class, $A, $B, $p, $q) = @_;
        ...
        $p //= Sidef::Types::Number::Number::ZERO;
    ...
    *imag = \&b;
    ...
    # Internal conversion to a numeric value (real or complex) or Quadratic object
    sub _convert {
        my ($self, $type) = @_;
