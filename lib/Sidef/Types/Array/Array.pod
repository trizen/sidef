...
I<Array> B<*> I<Num> -> I<Array>

Multiplies the array's elements I<n> times.

    ["x", "y"] * 2;     # returns: ["x", "y", "x", "y"]

Returns a new object of the same type as the self object.

Alias for: L<C<multiply()>|"multiply">
