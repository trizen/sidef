...
Left-justifies the string within a field of the given width by padding the right side with the specified padding string (default is a single space). If the string is already at or beyond the given width, it is returned unchanged.
