...
RangeNumber.each_almost_prime() -> I<Obj>
...
RangeNumber.each_powerful() -> I<Obj>
...
RangeNumber.each_semiprime() -> I<Obj>
...
RangeNumber.each_squarefree() -> I<Obj>
