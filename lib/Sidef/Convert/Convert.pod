...
Alias for L<C<toFile()>|"toFile">.

=cut

=head2 to_i

Alias for L<C<toInt()>|"toInt">.
...
Alias for L<C<toString()>|"toString">.

=cut

=head2 toStr

Convert.toStr() -> I<Bool>
