...
# Generated by:
# find . | perl -nE 'chomp; if(s/\.pm\z//){s{^\./}{};s{/}{::}g; next if $_ eq "Init" or $_ eq "Types::Regex::Matches" or $_ eq "Types::Number::NumberFast"; say "require Sidef::$_ if (caller)[0] ne q{Sidef::$_};"}'
