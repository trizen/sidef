...
=item * QUIT - Quit signal (Ctrl+\)

=item * KILL - Force kill (cannot be caught)

=item * PIPE - Broken pipe

=item * USR1, USR2 - User-defined signals

=item * STOP - Stop process (cannot be caught)

=item * CONT - Continue process
