...
require(I<String>)  ->  C<Sidef::Module::Caller>
...
When the Perl module is successfully loaded, it returns a C<Sidef::Module::Caller> object, which can call any method from the required module.
