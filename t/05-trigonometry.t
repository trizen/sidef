...

{
    ...
    my %tests = (
             asin  => [[$type, qr/^1\.570796326.*?\+2\.2924[^i]*i\z/], [$type,    qr/^0\.2013579207903307/],],
             ...
             atanh => [[$type, qr/^0\.2027325540540.*?\+1\.5707963267948966[^i]*i\z/], [$type, qr/^0\.20273255405408219/],],
             ...
             acsc  => [
                      ...
                      [$type, qr/^1\.570796326794896619231321.*?\+2\.29243166956117768780[^i]*i\z/],
                     ],
             ...
             acoth => [[$type,    qr/^0\.202732554054082190989006557/],
                       [$type, qr/^0\.2027325540540821909.*?\+1\.5707963267948966192[^i]*i/],
                      ],
                );
